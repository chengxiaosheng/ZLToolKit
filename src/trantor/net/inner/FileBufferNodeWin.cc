  ...
  public:
    FileBufferNode(const wchar_t *fileName, long long offset, long long length)
    {
        ...
        if (length == 0)
        {
            ...
            {
                ErrorL << "The file size is " << fileSize.QuadPart
    ...
    {
        ErrorL << "getFd() is not supported on Windows";
        return 0;
    }
