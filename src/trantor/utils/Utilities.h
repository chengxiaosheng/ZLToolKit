 ...
 */
ZLTOOLKIT_EXPORT std::string toUtf8(const std::wstring &wstr);
/**
 ...
 * @return converted string.
 */
ZLTOOLKIT_EXPORT std::wstring fromUtf8(const std::string &str);
 ...
 */
ZLTOOLKIT_EXPORT std::string fromWidePath(const std::wstring &strPath);
/**
 ...
 */
ZLTOOLKIT_EXPORT std::wstring toWidePath(const std::string &strUtf8Path);
 ...
 * "Botan"
 */
ZLTOOLKIT_EXPORT std::string tlsBackend();
 ...
 */
ZLTOOLKIT_EXPORT Hash128 md5(const void *data, size_t len);
 ...
 */
ZLTOOLKIT_EXPORT Hash160 sha1(const void *data, size_t len);
 ...
 */
ZLTOOLKIT_EXPORT Hash256 sha256(const void *data, size_t len);
 ...
 */
ZLTOOLKIT_EXPORT Hash256 sha3(const void *data, size_t len);
 ...
 * faster in software.
 */
ZLTOOLKIT_EXPORT Hash256 blake2b(const void *data, size_t len);
 ...
 * faster in software.
 */
ZLTOOLKIT_EXPORT std::string toHexString(const void *data, size_t len);
 ...
 */
ZLTOOLKIT_EXPORT bool secureRandomBytes(void *ptr, size_t size);
